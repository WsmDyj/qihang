...
const updateUser = async (username,nickname, userData = {}) => {
  ...
  const replySql = `update reply set reply_author ='${userData.nickname}', comment_author='${userData.nickname}' where comment_author ='${nickname}' and reply_author ='${nickname}';`
